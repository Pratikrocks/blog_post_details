...
from blog.views import (blog_post_detail_page, blog_post_list_view, blog_post_create_view, blog_post_delete_view,
                        blog_post_update_view, blog_post_retrieve_view)
